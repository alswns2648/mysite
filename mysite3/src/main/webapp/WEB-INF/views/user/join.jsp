			...
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="post"
					...
					<label class="block-label" for="name">이름</label> <input id="name"
						...
						class="block-label" for="email">이메일</label> <input
						id="input-email" name="email" type="text" value=""> <input
						id="btn-check-email" type="button" value="중복확인"> <img
						id="img-checked" style='width: 20px; display: none'
